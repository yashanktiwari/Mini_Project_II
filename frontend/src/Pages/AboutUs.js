            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:pb-16 lg:px-6 ">
                    ...
                    <div className="grid gap-12 mb-6 lg:mb-16 md:grid-cols-2">
                        <div
                            className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
                            <a href="#">
                            ...
                            <div className="p-5">
                                ...
                                <span className="text-gray-500 dark:text-gray-400">Full Stack Web Developer</span>
                                ...
                                <ul className="flex space-x-4 sm:mt-0">
                                    ...
                                    <li>
                                        <a href="#" className="text-[#00acee] dark:hover:text-white">
