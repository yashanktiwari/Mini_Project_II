...
const LoginBoxRetailerUser = () => {
    ...
    return (
        <>
            <div className="w-full px-1 py-1.5 md:px-2 md:py-2.5">
                <Tab.Group>
                    <Tab.List className="flex space-x-1 rounded-xl bg-white p-1">
                        <Tab
                            className={({selected}) =>
                                classNames(
                                    "w-full font-bold rounded-lg py-1 md:py-2.5 text-sm md:text-md leading-5 text-blue-700",
                        ...
                        <Tab
                            className={({selected}) =>
                                classNames(
                                    "w-full rounded-lg py-2.5 text-sm md:text-md font-bold leading-5 text-blue-700",
                                    "ring-white ring-opacity-60 ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2",
                                    selected
                                        ? "bg-sky-300 shadow"
                                        : "hover:bg-white/[0.12] hover:text-orange-600"
                        ...
                        <Tab.Panel>
                            <form onSubmit={handleULogin}>
                                <div className="mb-6">
                                    <label
                                        htmlFor="email"
                                        className="block mb-2 text-sm md:text-md font-bold mt-4 text-white"
                                    >
                                        User Email
                                    </label>
                                    <input
                                        type="email"
                                        id="email"
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm md:text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div className="mb-6">
                                    <label
                                        htmlFor="password"
                                        className="block mb-2 text-sm md:text-md font-bold text-white"
                                    >
                                        Password
                                    </label>
                                    <input
                                        type="password"
                                        id="password"
                                        className="bg-gray-50 border border-gray-300 text-black text-sm md:text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 font-medium dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div className="flex items-start mb-3 md:mb-6">
                                    <label
                                        htmlFor="remember"
                                        className="ml-2 text-sm md:text-md font-bold text-white mx-auto self-end hover:underline"
                                    >
                                ...
                                <div className="flex items-start mb-6">
                                    ...
                                    >
                                        <span className="font-bold text-sm md:text-md">
                                            ...
                                            <p>
                                            <Link to='/signupu' className="text-cyan-300 hover:underline">
                                                Create User Account
                                            </Link></p>
                                        </span>
                                    </label>
                                ...
                                <button
                                    type="submit"
                                    className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm md:text-md w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                >
                                    Login
                                </button>
                            </form>
                            ...
                            <form onSubmit={handleRLogin}>
                                ...
                                <div className="mb-6">
                                    ...
                                    <input
                                        type="password"
                                        id="password"
                                        className="bg-gray-50 border border-gray-300 text-black text-sm md:text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Password"
                                        required
                                        name="passwordr"
                                        onChange={(e) => {
                                ...
                                <div className="flex items-start mb-6">
                                    <label
                                        htmlFor="remember"
                                        className="ml-2 text-sm md:text-md font-bold text-white mx-auto self-end"
                                    >
                                <span>
                                    <p>Not Registered Yet ?{" "}</p>
                                    <p>
                                        <Link to='/signupr' className="text-cyan-300 hover:underline">
            ...
            {showModalu ? (
                <>
                    <div
                        ...
                        <div className="relative w-[17rem] md:w-[30rem] my-6 mx-auto max-w-3xl">
                            {/*content*/}
                            <div
                                className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                {/*header*/}
                                <div
                                    className="flex items-start justify-between md:justify-end px-5 py-3 md:p-5 border-b border-solid border-slate-200 rounded-t">
                    ...
                    <span
                      ...
                      ×
                                ...
                                <div className="relative px-4 flex-auto">
                                    <input className="my-4 p-2 w-full text-slate-500 text-md md:text-lg rounded-md leading-relaxed"
                                ...
                                {/*footer*/}
                                <div
                                    className="flex items-center justify-around p-2 md:p-6 border-t border-solid border-slate-200 rounded-b">
                                    <button
                                        className="text-red-500 background-transparent font-bold uppercase p-2 md:px-6 md:py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 hover:rounded hover:bg-gray-200"
                                        type="button"
                                        onClick={() => setShowModalu(false)}
                                    >
                                        Cancel
                                    ...
                                    <button
                                        className="bg-emerald-500 text-white active:bg-emerald-600 font-bold uppercase text-sm py-2 px-3 md:px-6 md:py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                        type="button"
